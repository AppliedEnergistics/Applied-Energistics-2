    ...
    class TextComplete extends TestBase {
        {
            ...
            addTest("a <abc . def.ghi>b</abc.def . ghi>.", "<p>a b.</p>",
            ...
            addTest("a <b c={1 + ({a: 1}).a}>c</b>.", "<p>a c.</p>",
            ...
            addTest("a *open <b> close* </b> c.", "<p>a <em>open  close</em>  c.</p>",
                    "should not care about precedence between attention (emphasis)");

            addTest("a **open <b> close** </b> c.", "<p>a <strong>open  close</strong>  c.</p>",
                    "should not care about precedence between attention (strong)");

            addTest("a [open <b> close](c) </b> d.", "<p>a <a href=\"c\">open  close</a>  d.</p>",
                    "should not care about precedence between label (link)");

            addTest("a ![open <b> close](c) </b> d.", "<p>a <img src=\"c\" alt=\"open  close\" />  d.</p>",
    ...
    abstract class TestBase {
        ...
        protected final String compile(String markdown) {
            return new HtmlCompiler(new CompileOptions().withExtension(HTML)).compile(
                    Micromark.parseAndPostprocess(markdown,
                            new ParseOptions().withSyntaxExtension(MdxSyntax.INSTANCE)));
        }
    }
}
