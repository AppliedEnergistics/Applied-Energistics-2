...
public class CodeIndentedTest {
    ...
    public void testDisabled() {
        ...
        TestUtil.assertGeneratedHtmlWithDisabled("   a", "<p>a</p>", "should support turning off code (indented, 1)",
                "codeIndented");

        TestUtil.assertGeneratedHtmlWithDisabled("> a^n    b", "<blockquote>^n<p>a^nb</p>^n</blockquote>",
                "should support turning off code (indented, 2)", "codeIndented");

        TestUtil.assertGeneratedHtmlWithDisabled("- a^n    b", "<ul>^n<li>a^nb</li>^n</ul>",
                "should support turning off code (indented, 3)", "codeIndented");

        TestUtil.assertGeneratedHtmlWithDisabled("- a^n    - b", "<ul>^n<li>a^n<ul>^n<li>b</li>^n</ul>^n</li>^n</ul>",
                "should support turning off code (indented, 4)", "codeIndented");

        TestUtil.assertGeneratedHtmlWithDisabled("- a^n    - b", "<ul>^n<li>a^n<ul>^n<li>b</li>^n</ul>^n</li>^n</ul>",
                "should support turning off code (indented, 5)", "codeIndented");

        TestUtil.assertGeneratedHtmlWithDisabled("```^na^n    ```", "<pre><code>a^n</code></pre>",
                "should support turning off code (indented, 6)", "codeIndented");
        ...
        TestUtil.assertGeneratedHtmlWithDisabled("- Foo^n---", "<ul>^n<li>Foo</li>^n</ul>^n<hr />",
                "should support turning off code (indented, 8)", "codeIndented");

        TestUtil.assertGeneratedHtmlWithDisabled("- Foo^n     ---", "<ul>^n<li>^n<h2>Foo</h2>^n</li>^n</ul>",
                "should support turning off code (indented, 9)", "codeIndented");
    }
