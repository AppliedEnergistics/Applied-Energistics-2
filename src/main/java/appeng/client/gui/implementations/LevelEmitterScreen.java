...
public class LevelEmitterScreen extends UpgradeableScreen<LevelEmitterMenu> {
    ...
    public LevelEmitterScreen(LevelEmitterMenu menu, Inventory playerInventory, Component title,
            ScreenStyle style) {
        ...
        this.level = new NumberEntryWidget(
                menu.getType() == LevelEmitterMenu.FLUID_TYPE ? NumberEntryType.LEVEL_FLUID_VOLUME
