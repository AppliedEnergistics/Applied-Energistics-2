...
import appeng.client.me.FluidSlotME;
 ...
 */
public class GuiFluidTerm extends AEBaseMEGui implements ISortSource, IConfigManagerHost
{
	private final List<FluidSlotME> meFluidSlots = new LinkedList<>();
	private final FluidRepo repo;
	private final IConfigManager configSrc;
	private final ContainerFluidTerm container;
	...
	public GuiFluidTerm( InventoryPlayer inventoryPlayer, PartFluidTerminal terminal )
	{
		super( new ContainerFluidTerm( inventoryPlayer, terminal ) );
		...
		( this.container = (ContainerFluidTerm) this.inventorySlots ).setGui( this );
	}
	...
	public void initGui()
	{
		...
		for( int y = 0; y < this.rows; y++ )
		{
			...
			{
				FluidSlotME slot = new FluidSlotME( new InternalFluidSlotME( this.repo, x + y * this.perRow, this.offsetX + x * 18, 18 + y * 18 ) );
	...
	{
		if( slot instanceof FluidSlotME )
		{
			FluidSlotME meSlot = (FluidSlotME) slot;
	...
	protected List<FluidSlotME> getMeFluidSlots()
	{
