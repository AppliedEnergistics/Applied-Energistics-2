...
public class ScreenRegistration {
    ...
    public static void register() {
        ...
        register(FluidIOContainer.IMPORT_TYPE, FluidIOBusScreen::new, "/screens/fluid_import_bus.json");
        register(FluidIOContainer.EXPORT_TYPE, FluidIOBusScreen::new, "/screens/fluid_export_bus.json");
