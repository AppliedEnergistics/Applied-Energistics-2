    ...
    protected void renderTooltip(MatrixStack matrixStack, final ItemStack stack, final int x, final int y) {
        ...
        if (s instanceof SlotME && !stack.isEmpty()) {
            ...
            if (myStack != null) {
                ...
                this.renderToolTip(matrixStack, Lists.transform(currentToolTip, ITextComponent::getVisualOrderText), x,
                        y,
                        this.font);
                ...
                currentToolTip.add(ButtonToolTips.ItemsStored.text(formattedAmount).withStyle(TextFormatting.GRAY));
