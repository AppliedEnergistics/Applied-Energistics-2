...
public final class AERenderPipelines {
    ...
    public static final RenderPipeline SPATIAL_SKYBOX_SPARKLES = RenderPipeline.builder(RenderPipelines.MATRICES_COLOR_SNIPPET)
    ...
    public static final RenderPipeline AREA_OVERLAY_FACE = RenderPipeline.builder(RenderPipelines.MATRICES_COLOR_SNIPPET)
    ...
    public static final RenderPipeline AREA_OVERLAY_LINE_OCCLUDED = RenderPipeline.builder(RenderPipelines.LINES_SNIPPET)
            .withLocation(AppEng.makeId("pipeline/area_overlay_line_occluded"))
            .withDepthTestFunction(DepthTestFunction.GREATER_DEPTH_TEST)
            .withDepthWrite(false)
            .build();

    public static final RenderPipeline STORAGE_CELL_LEDS = RenderPipeline.builder(RenderPipelines.MATRICES_COLOR_SNIPPET)
