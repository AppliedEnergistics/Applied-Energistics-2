			...
			try
			{
				switch( stage )
				{
					case PRE_INIT:
						...
						AEConfig.instance.addCustomCategoryComment( "ModIntegration", "Valid Values are 'AUTO', 'ON', or 'OFF' - defaults to " +
                                "'AUTO' ; Suggested that you leave this alone unless you're experiencing an issue, or wish to disable the " +
