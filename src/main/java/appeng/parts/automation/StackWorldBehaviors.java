...
public final class StackWorldBehaviors {
    ...
    static {
        ...
        registerPickupStrategy(AEKeyType.fluids(), (level, pos, side, host, enchantments, owningPlayerId) -> new FluidPickupStrategy(level, pos, side, host, enchantments, owningPlayerId));
        registerPickupStrategy(AEKeyType.items(), (level, pos, side, host, enchantments, owningPlayerId) -> new ItemPickupStrategy(level, pos, side, host, enchantments, owningPlayerId));
    }
