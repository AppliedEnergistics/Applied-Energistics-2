...
public abstract class SharedItemBusPart extends UpgradeablePart implements IGridTickable {
    ...
    protected InventoryAdaptor getHandler() {
        ...
        final TileEntity target = this.getTileEntity(self, self.getBlockPos().relative(this.getSide().getFacing()));
    ...
    protected boolean canDoBusWork() {
        final TileEntity self = this.getHost().getTile();
        final BlockPos selfPos = self.getBlockPos().relative(this.getSide().getFacing());
