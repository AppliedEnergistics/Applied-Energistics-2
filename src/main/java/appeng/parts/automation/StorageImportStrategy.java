    ...
    public boolean transfer(StackTransferContext context) {
        ...
        for (int i = 0; i < adjacentStorage.getSlots(); i++) {
            ...
            if (resource == null
                    ...
                    || !context.isInFilter(resource.what())) {
                continue;
            }
            ...
            var amountForThisResource = inv.insert(resource.what(), remainingTransferAmount,
                    Actionable.SIMULATE,
            ...
            var amount = adjacentStorage.extract(resource.what(), amountForThisResource, Actionable.MODULATE,
                    context.getActionSource());
            if (amount > 0) {
                var inserted = inv.insert(resource.what(), amount, Actionable.MODULATE, context.getActionSource());
