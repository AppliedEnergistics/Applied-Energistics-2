...
public interface QuadView {
     ...
     *
     * @param spriteIndex The sprite to be used for the quad. Behavior for values &gt; 0 is currently undefined.
     *
     ...
     *                    index.
     *
     * @param isItem      If true, will output vertex normals. Otherwise will output lightmaps, per Minecraft vertex
     ...
     *
     * @param spriteIndex The sprite to be used for the quad. Behavior for {@code spriteIndex > 0} is currently
     *                    undefined.
     *
     * @param sprite      {@link MutableQuadView} does not serialize sprites so the sprite must be provided by the
     *                    caller.
     *
     * @param isItem      If true, will output vertex normals. Otherwise will output lightmaps, per Minecraft vertex
     *                    formats for baked models.
