...
public class GuiSpriteManagerMixin extends TextureAtlasHolder {
    public GuiSpriteManagerMixin(TextureManager textureManager, ResourceLocation textureAtlasLocation,
    ...
    private TextureAtlasSprite redirectToDarkModeSprite(GuiSpriteManager manager, ResourceLocation id,
