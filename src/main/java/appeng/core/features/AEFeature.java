...
public enum AEFeature
{
	...
	LEVEL_EMITTER_FLUID( "LevelEmitterFluid", Constants.CATEGORY_NETWORK_BUSES ),
	...
	IMPORT_BUS_FLUID( "ImportBusFluid", Constants.CATEGORY_NETWORK_BUSES ),
	EXPORT_BUS( "ExportBus", Constants.CATEGORY_NETWORK_BUSES ),
	EXPORT_BUS_FLUID( "ExportBusFluid", Constants.CATEGORY_NETWORK_BUSES ),
	STORAGE_BUS( "StorageBus", Constants.CATEGORY_NETWORK_BUSES ),
	STORAGE_BUS_FLUID( "StorageBusFluid", Constants.CATEGORY_NETWORK_BUSES ),
