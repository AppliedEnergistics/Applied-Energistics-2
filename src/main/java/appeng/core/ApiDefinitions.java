...
public final class ApiDefinitions implements IDefinitions
{
	...
	public ApiDefinitions( IPartHelper partHelper )
	{
		...
		final DefinitionConstructor definitionConstructor = new DefinitionConstructor( this.features, this.handlers );
		...
		this.parts = new ApiParts( definitionConstructor, partHelper );
	}
