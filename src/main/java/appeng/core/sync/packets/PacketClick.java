...
public class PacketClick extends AppEngPacket
{
	...
	public void serverPacketData(INetworkInfo manager, AppEngPacket packet, EntityPlayer player)
	{
		...
		final AEItemDefinition maybeMemoryCard = items.memoryCard();
		final AEItemDefinition maybeColorApplicator = items.colorApplicator();
		...
		if ( is != null )
		{
			...
			else if ( maybeMemoryCard.sameAsStack( is ) )
			{
			...
			else if ( maybeColorApplicator.sameAsStack( is ) )
			{
