...
public final class AEParts {
    ...
    public static final ItemDefinition<PartItem<ItemFormationPlanePart>> FORMATION_PLANE = createPart(AEPartIds.ITEM_FORMATION_PLANE, ItemFormationPlanePart.class, ItemFormationPlanePart::new);
    ...
    public static final ItemDefinition<PartItem<InterfaceTerminalPart>> INTERFACE_TERMINAL = createPart(AEPartIds.PATTERN_PROVIDER_TERMINAL, InterfaceTerminalPart.class, InterfaceTerminalPart::new);
