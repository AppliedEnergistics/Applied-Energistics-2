...
public final class AEParts {
    ...
    public static final ItemDefinition<PartItem<CraftingInterfacePart>> CRAFTING_INTERFACE = createPart(AEPartIds.CRAFTING_INTERFACE, CraftingInterfacePart.class, CraftingInterfacePart::new);
