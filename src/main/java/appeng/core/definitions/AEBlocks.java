...
public final class AEBlocks {
    ...
    public static final BlockDefinition<QuartzOreBlock> QUARTZ_ORE = block(AEBlockIds.QUARTZ_ORE,
            () -> new QuartzOreBlock(QUARTZ_PROPERTIES));
    public static final BlockDefinition<MatrixFrameBlock> MATRIX_FRAME = block(AEBlockIds.MATRIX_FRAME,
            MatrixFrameBlock::new);

    public static final BlockDefinition<AEDecorativeBlock> QUARTZ_BLOCK = block(AEBlockIds.QUARTZ_BLOCK,
            () -> new AEDecorativeBlock(QUARTZ_PROPERTIES));
    public static final BlockDefinition<QuartzPillarBlock> QUARTZ_PILLAR = block(AEBlockIds.QUARTZ_PILLAR,
            () -> new QuartzPillarBlock(QUARTZ_PROPERTIES));
    public static final BlockDefinition<AEDecorativeBlock> CHISELED_QUARTZ_BLOCK = block(
            AEBlockIds.CHISELED_QUARTZ_BLOCK, () -> new AEDecorativeBlock(QUARTZ_PROPERTIES));

    public static final BlockDefinition<QuartzGlassBlock> QUARTZ_GLASS = block(AEBlockIds.QUARTZ_GLASS,
            () -> new QuartzGlassBlock(defaultProps(Material.GLASS).noOcclusion().isValidSpawn(NEVER_ALLOW_SPAWN)));
    public static final BlockDefinition<QuartzLampBlock> QUARTZ_VIBRANT_GLASS = block(AEBlockIds.QUARTZ_VIBRANT_GLASS,
            () -> new QuartzLampBlock(defaultProps(Material.GLASS).lightLevel(b -> 15).noOcclusion()
                    .isValidSpawn(NEVER_ALLOW_SPAWN)));

    public static final BlockDefinition<QuartzFixtureBlock> QUARTZ_FIXTURE = block(AEBlockIds.QUARTZ_FIXTURE,
            QuartzFixtureBlock::new);
    ...
    public static final BlockDefinition<TinyTNTBlock> TINY_TNT = block(AEBlockIds.TINY_TNT,
            () -> new TinyTNTBlock(defaultProps(Material.EXPLOSIVE).sound(SoundType.GRAVEL).strength(0).noOcclusion()));
    public static final BlockDefinition<SecurityStationBlock> SECURITY_STATION = block(AEBlockIds.SECURITY_STATION,
            SecurityStationBlock::new);

    public static final BlockDefinition<QuantumRingBlock> QUANTUM_RING = block(AEBlockIds.QUANTUM_RING,
            QuantumRingBlock::new);
    public static final BlockDefinition<QuantumLinkChamberBlock> QUANTUM_LINK = block(AEBlockIds.QUANTUM_LINK,
            QuantumLinkChamberBlock::new);
    public static final BlockDefinition<SpatialPylonBlock> SPATIAL_PYLON = block(AEBlockIds.SPATIAL_PYLON,
            SpatialPylonBlock::new);
    public static final BlockDefinition<SpatialIOPortBlock> SPATIAL_IO_PORT = block(AEBlockIds.SPATIAL_IO_PORT,
            SpatialIOPortBlock::new);
    public static final BlockDefinition<ControllerBlock> CONTROLLER = block(AEBlockIds.CONTROLLER,
            ControllerBlock::new);
    ...
    public static final BlockDefinition<ItemInterfaceBlock> ITEM_INTERFACE = block(AEBlockIds.ITEM_INTERFACE,
            ItemInterfaceBlock::new);
    public static final BlockDefinition<FluidInterfaceBlock> FLUID_INTERFACE = block(AEBlockIds.FLUID_INTERFACE,
            FluidInterfaceBlock::new);
    public static final BlockDefinition<CellWorkbenchBlock> CELL_WORKBENCH = block(AEBlockIds.CELL_WORKBENCH,
            CellWorkbenchBlock::new);
    ...
    public static final BlockDefinition<EnergyAcceptorBlock> ENERGY_ACCEPTOR = block(AEBlockIds.ENERGY_ACCEPTOR,
            EnergyAcceptorBlock::new);
    public static final BlockDefinition<VibrationChamberBlock> VIBRATION_CHAMBER = block(AEBlockIds.VIBRATION_CHAMBER,
            VibrationChamberBlock::new);
    public static final BlockDefinition<QuartzGrowthAcceleratorBlock> QUARTZ_GROWTH_ACCELERATOR = block(
            AEBlockIds.QUARTZ_GROWTH_ACCELERATOR, QuartzGrowthAcceleratorBlock::new);
    public static final BlockDefinition<EnergyCellBlock> ENERGY_CELL = block(AEBlockIds.ENERGY_CELL,
            EnergyCellBlock::new, AEBaseBlockItemChargeable::new);
    public static final BlockDefinition<DenseEnergyCellBlock> DENSE_ENERGY_CELL = block(AEBlockIds.DENSE_ENERGY_CELL,
            DenseEnergyCellBlock::new, AEBaseBlockItemChargeable::new);
    public static final BlockDefinition<CreativeEnergyCellBlock> CREATIVE_ENERGY_CELL = block(
            AEBlockIds.CREATIVE_ENERGY_CELL, CreativeEnergyCellBlock::new);

    public static final BlockDefinition<CraftingUnitBlock> CRAFTING_UNIT = block(AEBlockIds.CRAFTING_UNIT,
            () -> new CraftingUnitBlock(defaultProps(Material.METAL), CraftingUnitType.UNIT));
    public static final BlockDefinition<CraftingUnitBlock> CRAFTING_ACCELERATOR = block(AEBlockIds.CRAFTING_ACCELERATOR,
            () -> new CraftingUnitBlock(defaultProps(Material.METAL), CraftingUnitType.ACCELERATOR));

    public static final BlockDefinition<CraftingStorageBlock> CRAFTING_STORAGE_1K = block(
            AEBlockIds.CRAFTING_STORAGE_1K,
            () -> new CraftingStorageBlock(defaultProps(Material.METAL), CraftingUnitType.STORAGE_1K),
            CraftingStorageItem::new);
    public static final BlockDefinition<CraftingStorageBlock> CRAFTING_STORAGE_4K = block(
            AEBlockIds.CRAFTING_STORAGE_4K,
            () -> new CraftingStorageBlock(defaultProps(Material.METAL), CraftingUnitType.STORAGE_4K),
            CraftingStorageItem::new);
    public static final BlockDefinition<CraftingStorageBlock> CRAFTING_STORAGE_16K = block(
            AEBlockIds.CRAFTING_STORAGE_16K,
            () -> new CraftingStorageBlock(defaultProps(Material.METAL), CraftingUnitType.STORAGE_16K),
            CraftingStorageItem::new);
    public static final BlockDefinition<CraftingStorageBlock> CRAFTING_STORAGE_64K = block(
            AEBlockIds.CRAFTING_STORAGE_64K,
            () -> new CraftingStorageBlock(defaultProps(Material.METAL), CraftingUnitType.STORAGE_64K),
            CraftingStorageItem::new);
    public static final BlockDefinition<CraftingMonitorBlock> CRAFTING_MONITOR = block(AEBlockIds.CRAFTING_MONITOR,
            () -> new CraftingMonitorBlock(defaultProps(Material.METAL)));

    public static final BlockDefinition<PatternProviderBlock> PATTERN_PROVIDER = block(AEBlockIds.PATTERN_PROVIDER,
            PatternProviderBlock::new);
    public static final BlockDefinition<MolecularAssemblerBlock> MOLECULAR_ASSEMBLER = block(
            AEBlockIds.MOLECULAR_ASSEMBLER,
            () -> new MolecularAssemblerBlock(defaultProps(Material.METAL).noOcclusion()));

    public static final BlockDefinition<LightDetectorBlock> LIGHT_DETECTOR = block(AEBlockIds.LIGHT_DETECTOR,
    ...
    public static final BlockDefinition<StairBlock> SKY_STONE_STAIRS = block(AEBlockIds.SKY_STONE_STAIRS,
            () -> new StairBlock(SKY_STONE_BLOCK.block()::defaultBlockState, SKYSTONE_PROPERTIES));
    public static final BlockDefinition<StairBlock> SMOOTH_SKY_STONE_STAIRS = block(AEBlockIds.SMOOTH_SKY_STONE_STAIRS,
            () -> new StairBlock(SMOOTH_SKY_STONE_BLOCK.block()::defaultBlockState, SKYSTONE_PROPERTIES));
    public static final BlockDefinition<StairBlock> SKY_STONE_BRICK_STAIRS = block(AEBlockIds.SKY_STONE_BRICK_STAIRS,
            () -> new StairBlock(SKY_STONE_BRICK.block()::defaultBlockState, SKYSTONE_PROPERTIES));
    public static final BlockDefinition<StairBlock> SKY_STONE_SMALL_BRICK_STAIRS = block(
            AEBlockIds.SKY_STONE_SMALL_BRICK_STAIRS,
            () -> new StairBlock(SKY_STONE_SMALL_BRICK.block()::defaultBlockState, SKYSTONE_PROPERTIES));
    public static final BlockDefinition<StairBlock> FLUIX_STAIRS = block(AEBlockIds.FLUIX_STAIRS,
            () -> new StairBlock(FLUIX_BLOCK.block()::defaultBlockState, QUARTZ_PROPERTIES));
    public static final BlockDefinition<StairBlock> QUARTZ_STAIRS = block(AEBlockIds.QUARTZ_STAIRS,
            () -> new StairBlock(QUARTZ_BLOCK.block()::defaultBlockState, QUARTZ_PROPERTIES));
    public static final BlockDefinition<StairBlock> CHISELED_QUARTZ_STAIRS = block(AEBlockIds.CHISELED_QUARTZ_STAIRS,
            () -> new StairBlock(CHISELED_QUARTZ_BLOCK.block()::defaultBlockState, QUARTZ_PROPERTIES));
    public static final BlockDefinition<StairBlock> QUARTZ_PILLAR_STAIRS = block(AEBlockIds.QUARTZ_PILLAR_STAIRS,
            () -> new StairBlock(QUARTZ_PILLAR.block()::defaultBlockState, QUARTZ_PROPERTIES));
    ...
    public static final BlockDefinition<WallBlock> SKY_STONE_BRICK_WALL = block(AEBlockIds.SKY_STONE_BRICK_WALL,
            () -> new WallBlock(SKYSTONE_PROPERTIES));
    public static final BlockDefinition<WallBlock> SKY_STONE_SMALL_BRICK_WALL = block(
            AEBlockIds.SKY_STONE_SMALL_BRICK_WALL, () -> new WallBlock(SKYSTONE_PROPERTIES));
    ...
    public static final BlockDefinition<SlabBlock> SKY_STONE_SLAB = block(AEBlockIds.SKY_STONE_SLAB,
            () -> new SlabBlock(SKYSTONE_PROPERTIES));
    ...
    public static final BlockDefinition<SlabBlock> SKY_STONE_BRICK_SLAB = block(AEBlockIds.SKY_STONE_BRICK_SLAB,
            () -> new SlabBlock(SKYSTONE_PROPERTIES));
    public static final BlockDefinition<SlabBlock> SKY_STONE_SMALL_BRICK_SLAB = block(
            AEBlockIds.SKY_STONE_SMALL_BRICK_SLAB, () -> new SlabBlock(SKYSTONE_PROPERTIES));

    public static final BlockDefinition<SlabBlock> FLUIX_SLAB = block(AEBlockIds.FLUIX_SLAB,
            () -> new SlabBlock(QUARTZ_PROPERTIES));
    ...
    public static final BlockDefinition<SpatialAnchorBlock> SPATIAL_ANCHOR = block(AEBlockIds.SPATIAL_ANCHOR,
            SpatialAnchorBlock::new);

    ///
    /// DEBUG BLOCKS
    ///
    public static final BlockDefinition<ItemGenBlock> DEBUG_ITEM_GEN = block(AppEng.makeId("debug_item_gen"),
            ItemGenBlock::new);
    public static final BlockDefinition<ChunkLoaderBlock> DEBUG_CHUNK_LOADER = block(
            AppEng.makeId("debug_chunk_loader"), ChunkLoaderBlock::new);
    public static final BlockDefinition<PhantomNodeBlock> DEBUG_PHANTOM_NODE = block(
            AppEng.makeId("debug_phantom_node"), PhantomNodeBlock::new);
    public static final BlockDefinition<CubeGeneratorBlock> DEBUG_CUBE_GEN = block(AppEng.makeId("debug_cube_gen"),
            CubeGeneratorBlock::new);
    public static final BlockDefinition<EnergyGeneratorBlock> DEBUG_ENERGY_GEN = block(
            AppEng.makeId("debug_energy_gen"), EnergyGeneratorBlock::new);
    // spotless:on
