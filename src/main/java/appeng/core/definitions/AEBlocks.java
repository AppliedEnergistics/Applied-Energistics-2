...
public final class AEBlocks {
    ...
    public static final BlockDefinition<QuartzOreBlock> DEEPSLATE_QUARTZ_ORE = block(AEBlockIds.DEEPSLATE_QUARTZ_ORE, () -> new QuartzOreBlock(QUARTZ_PROPERTIES.strength(4.5f, 5).sound(SoundType.DEEPSLATE)));
    ...
    public static final BlockDefinition<InterfaceBlock> INTERFACE = block(AEBlockIds.INTERFACE, InterfaceBlock::new);
