...
public enum ButtonToolTips implements LocalizationEnum {
    ...
    ShowAll("Show All"),
    ShowAllPatterns("Show All Pattern Providers"),
    ShowUnhiddenPatterns("Show Unhidden Pattern Providers only"),
    ShowUnfilledPatterns("Show Pattern Providers with empty slots"),
