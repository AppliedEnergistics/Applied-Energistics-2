...
public enum ButtonToolTips implements LocalizationEnum {
    ...
    SearchByPatternProviderName("Search by Pattern Provider's name"),
    SearchByPatternInputs("Search by pattern inputs"),
    SearchByPatternOutputs("Search by pattern outputs"),
