...
public enum ButtonToolTips implements LocalizationEnum {
    ...
    AutoExportOff("Produced items will not be auto-exported."),
    AutoExportOn("Produced items will be auto-exported through any extraction side."),
    BlockPlacement("Block Placement"),
    BlockPlacementNo("Blocks will be dropped as items."),
    BlockPlacementYes("Blocks will be placed as blocks."),
    ...
    EmitLevelAbove("Emit when levels are above or equal to the limit."),
    EmitLevelsBelow("Emit when levels are below the limit."),
