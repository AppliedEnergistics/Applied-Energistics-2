...
public enum ButtonToolTips {
    ...
    Craftable("Craftable"),
    CraftableBy("Automatic CPU selection mode"),
    CraftableByAll("Usable by both players and automation"),
    CraftableByPlayers("Automatically usable by players only"),
    CraftableByAutomation("Automatically usable by automation only"),
