...
@Mod( modid = AppEng.MOD_ID, acceptedMinecraftVersions = "[1.12,1.12.2]", name = AppEng.MOD_NAME, version = AEConfig.VERSION, dependencies = AppEng.MOD_DEPENDENCIES, guiFactory = "appeng.client.gui.config.AEConfigGuiFactory" )
