...
public final class ContainerSecurity extends ContainerMEMonitorable implements IAEAppEngInventory
{
	...
	public final void toggleSetting( String value, EntityPlayer player )
	{
		try
		{
