 ...
 */
public class ContainerFluidTerm extends AEBaseContainer implements IConfigManagerHost, IConfigurableObject, IMEMonitorHandlerReceiver<IAEFluidStack>
{
	...
	public ContainerFluidTerm( InventoryPlayer ip, PartFluidTerminal terminal )
	{
		super( ip, terminal );
