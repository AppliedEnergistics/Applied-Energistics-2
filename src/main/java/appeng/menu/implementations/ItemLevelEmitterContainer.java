...
public class ItemLevelEmitterContainer extends UpgradeableContainer {

    public static final MenuType<ItemLevelEmitterContainer> TYPE = ContainerTypeBuilder
            .create(ItemLevelEmitterContainer::new, LevelEmitterPart.class)
    ...
    public ItemLevelEmitterContainer(int id, final Inventory ip, final LevelEmitterPart te) {
        super(TYPE, id, ip, te);
        this.lvlEmitter = te;
    }
