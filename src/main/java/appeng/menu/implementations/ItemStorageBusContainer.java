 ...
 */
public class ItemStorageBusContainer extends UpgradeableContainer {

    public static final MenuType<ItemStorageBusContainer> TYPE = ContainerTypeBuilder
            .create(ItemStorageBusContainer::new, StorageBusPart.class)
    ...
    public ItemStorageBusContainer(int id, final Inventory ip, final StorageBusPart te) {
        super(TYPE, id, ip, te);
        this.storageBus = te;
    }
