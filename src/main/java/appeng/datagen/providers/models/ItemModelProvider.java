...
public class ItemModelProvider extends net.minecraftforge.client.model.generators.ItemModelProvider
    ...
    protected void registerModels() {
        ...
        flatSingleLayer(AEItems.FLUID_CELL_1K, "item/1k_fluid_storage_cell");
        flatSingleLayer(AEItems.FLUID_CELL_4K, "item/4k_fluid_storage_cell");
        flatSingleLayer(AEItems.FLUID_CELL_16K, "item/16k_fluid_storage_cell");
        flatSingleLayer(AEItems.FLUID_CELL_64K, "item/64k_fluid_storage_cell");
