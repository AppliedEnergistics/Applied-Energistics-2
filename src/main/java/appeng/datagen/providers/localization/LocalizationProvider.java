...
public class LocalizationProvider implements IAE2DataProvider {
    ...
    private void generateLocalizations() {
        ...
        add("patchouli.ae2.guidebook_landingtext",
                "This is a work-in-progress guidebook for Applied Energistics 2.$(br2)More information about the mod can be found on the existing $(l:https://appliedenergistics.github.io/)official wiki$(/l)");
