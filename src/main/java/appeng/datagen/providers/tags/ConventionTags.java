...
public final class ConventionTags {
    ...
    public static Tag.Named<Item> NETHER_QUARTZ_DUST = tag("c:quartz_dusts");
    ...
    public static Tag.Named<Item> GOLD_DUST = tag("c:gold_dusts");

    public static Tag.Named<Item> IRON_INGOT = tag("c:iron_ingots");
    public static Tag.Named<Item> IRON_ORE = tag("c:iron_ores");
    public static Tag.Named<Item> IRON_DUST = tag("c:iron_dusts");
    ...
    public static Tag.Named<Item> WOOD_GEAR = tag("c:wooden_gears");
