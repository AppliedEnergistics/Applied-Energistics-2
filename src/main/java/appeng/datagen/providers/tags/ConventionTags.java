...
public final class ConventionTags {
    ...
    public final static TagKey<Item> CERTUS_QUARTZ = tag("c:certus_quartz");
    public final static TagKey<Item> CERTUS_QUARTZ_ORE = tag("c:certus_quartz_ores");
    public final static TagKey<Block> CERTUS_QUARTZ_ORE_BLOCK = blockTag("c:certus_quartz_ores");
    public final static TagKey<Block> CERTUS_QUARTZ_STORAGE_BLOCK_BLOCK = blockTag("c:certus_quartz_blocks");
    public final static TagKey<Item> CERTUS_QUARTZ_DUST = tag("c:certus_quartz_dusts");
