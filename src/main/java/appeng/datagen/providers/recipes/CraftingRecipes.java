...
public class CraftingRecipes extends AE2RecipeProvider {
    ...
    protected void buildAE2CraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(AEBlocks.GRINDSTONE)
                .pattern("aba")
                .pattern("cac")
                .pattern("dcd")
                .define('a', ConventionTags.STONE)
                .define('b', ConventionTags.WOOD_GEAR)
                .define('c', ConventionTags.ALL_QUARTZ)
                .define('d', ConventionTags.COBBLESTONE)
                .unlockedBy("has_cobblestone", has(ConventionTags.COBBLESTONE))
                .unlockedBy("has_stone", has(ConventionTags.STONE))
                .unlockedBy("has_gears/wooden", has(ConventionTags.WOOD_GEAR))
                .unlockedBy("has_crystals/quartz", has(ConventionTags.ALL_QUARTZ))
                .save(consumer, AppEng.makeId("misc/grindstone"));
        ShapedRecipeBuilder.shaped(AEBlocks.CRANK)
                .pattern("aaa")
                .pattern("  a")
                .pattern("  a")
                .define('a', ConventionTags.WOOD_STICK)
                .unlockedBy("has_grindstone", has(AEBlocks.GRINDSTONE))
                .save(consumer, AppEng.makeId("misc/grindstone_crank"));
        ShapedRecipeBuilder.shaped(AEItems.WOODEN_GEAR)
                .pattern(" a ")
                .pattern("a a")
                .pattern(" a ")
                .define('a', ConventionTags.WOOD_STICK)
                .unlockedBy("has_rods/wooden", has(ConventionTags.WOOD_STICK))
                .save(consumer, AppEng.makeId("misc/grindstone_woodengear"));
