...
public class CraftingRecipes extends AE2RecipeProvider {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ShapelessRecipeBuilder.shapeless(AEItems.CARD_CRAFTING)
                ...
                .requires(AEItems.BASIC_CARD)
                .unlockedBy("has_basic_card", has(AEItems.BASIC_CARD))
                .unlockedBy("has_workbench", has(Items.CRAFTING_TABLE))
        ...
        ShapedRecipeBuilder.shaped(AEBlocks.SKY_COMPASS)
                ...
                .unlockedBy("has_ingots/iron", has(ConventionTags.IRON_INGOT))
        ...
        ShapedRecipeBuilder.shaped(Items.COMPARATOR)
                ...
                .unlockedBy("has_stone", has(ConventionTags.STONE))
                .unlockedBy("has_crystals/nether", has(ConventionTags.ALL_NETHER_QUARTZ))
                .unlockedBy("has_redstone_torch", has(Items.REDSTONE_TORCH))
        ...
        ShapedRecipeBuilder.shaped(Items.DAYLIGHT_DETECTOR)
                ...
                .unlockedBy("has_glass", has(ConventionTags.GLASS))
                .unlockedBy("has_crystals/nether", has(ConventionTags.ALL_NETHER_QUARTZ))
        ...
        ShapedRecipeBuilder.shaped(AEBlocks.CELL_WORKBENCH)
                ...
                .unlockedBy("has_ingots/iron", has(ConventionTags.IRON_INGOT))
                .unlockedBy("has_calculation_processor", has(AEItems.CALCULATION_PROCESSOR))
                .unlockedBy("has_chests/wooden", has(ConventionTags.CHEST))
                .unlockedBy("has_wool", has(ItemTags.WOOL))
        ...
        ShapedRecipeBuilder.shaped(AEBlocks.FLUID_INTERFACE)
                ...
                .unlockedBy("has_ingots/iron", has(ConventionTags.IRON_INGOT))
                .unlockedBy("has_dyes/green", has(ConventionTags.dye(DyeColor.GREEN)))
        ...
        ShapedRecipeBuilder.shaped(AEParts.COVERED_CABLE.item(AEColor.BLACK), 8)
                ...
                .define('b', ConventionTags.dye(DyeColor.BLACK))
                .unlockedBy("has_dyes/black", has(ConventionTags.dye(DyeColor.BLACK)))
        ...
        ShapedRecipeBuilder.shaped(AEParts.COVERED_CABLE.item(AEColor.BLUE), 8)
                ...
                .unlockedBy("has_fluix_covered_cable", has(AEParts.COVERED_CABLE.item(AEColor.TRANSPARENT)))
                .unlockedBy("has_dyes/blue", has(ConventionTags.dye(DyeColor.BLUE)))
        ...
        ShapedRecipeBuilder.shaped(AEParts.COVERED_CABLE.item(AEColor.BROWN), 8)
                ...
                .pattern("aaa")
                .define('a', AEParts.COVERED_CABLE.item(AEColor.TRANSPARENT))
                .define('b', ConventionTags.dye(DyeColor.BROWN))
                .unlockedBy("has_dyes/brown", has(ConventionTags.dye(DyeColor.BROWN)))
                .unlockedBy("has_fluix_covered_cable", has(AEParts.COVERED_CABLE.item(AEColor.TRANSPARENT)))
        ...
        ShapedRecipeBuilder.shaped(AEParts.COVERED_CABLE.item(AEColor.CYAN), 8)
                ...
                .pattern("aaa")
                .define('a', AEParts.COVERED_CABLE.item(AEColor.TRANSPARENT))
                .define('b', ConventionTags.dye(DyeColor.CYAN))
                .unlockedBy("has_dyes/cyan", has(ConventionTags.dye(DyeColor.CYAN)))
                .unlockedBy("has_fluix_covered_cable", has(AEParts.COVERED_CABLE.item(AEColor.TRANSPARENT)))
        ...
        ShapedRecipeBuilder.shaped(AEParts.COVERED_CABLE.item(AEColor.GRAY), 8)
                ...
                .pattern("aaa")
                .define('a', AEParts.COVERED_CABLE.item(AEColor.TRANSPARENT))
                .define('b', ConventionTags.dye(DyeColor.GRAY))
                .unlockedBy("has_dyes/gray", has(ConventionTags.dye(DyeColor.GRAY)))
                .unlockedBy("has_fluix_covered_cable", has(AEParts.COVERED_CABLE.item(AEColor.TRANSPARENT)))
        ...
        ShapedRecipeBuilder.shaped(AEParts.COVERED_CABLE.item(AEColor.LIGHT_BLUE), 8)
                ...
                .pattern("aaa")
                .define('a', AEParts.COVERED_CABLE.item(AEColor.TRANSPARENT))
                .define('b', ConventionTags.dye(DyeColor.LIGHT_BLUE))
                .unlockedBy("has_fluix_covered_cable", has(AEParts.COVERED_CABLE.item(AEColor.TRANSPARENT)))
                .unlockedBy("has_dyes/light_blue", has(ConventionTags.dye(DyeColor.LIGHT_BLUE)))
        ...
        ShapedRecipeBuilder.shaped(AEParts.COVERED_CABLE.item(AEColor.LIGHT_GRAY), 8)
                ...
                .pattern("aaa")
                .define('a', AEParts.COVERED_CABLE.item(AEColor.TRANSPARENT))
                .define('b', ConventionTags.dye(DyeColor.LIGHT_GRAY))
                .unlockedBy("has_fluix_covered_cable", has(AEParts.COVERED_CABLE.item(AEColor.TRANSPARENT)))
                .unlockedBy("has_dyes/light_gray", has(ConventionTags.dye(DyeColor.LIGHT_GRAY)))
        ...
        ShapedRecipeBuilder.shaped(AEParts.COVERED_CABLE.item(AEColor.LIME), 8)
                ...
                .pattern("aaa")
                .define('a', AEParts.COVERED_CABLE.item(AEColor.TRANSPARENT))
                .define('b', ConventionTags.dye(DyeColor.LIME))
                .unlockedBy("has_fluix_covered_cable", has(AEParts.COVERED_CABLE.item(AEColor.TRANSPARENT)))
                .unlockedBy("has_dyes/lime", has(ConventionTags.dye(DyeColor.LIME)))
        ...
        ShapedRecipeBuilder.shaped(AEParts.COVERED_CABLE.item(AEColor.MAGENTA), 8)
                ...
                .pattern("aaa")
                .define('a', AEParts.COVERED_CABLE.item(AEColor.TRANSPARENT))
                .define('b', ConventionTags.dye(DyeColor.MAGENTA))
                .unlockedBy("has_dyes/magenta", has(ConventionTags.dye(DyeColor.MAGENTA)))
                .unlockedBy("has_fluix_covered_cable", has(AEParts.COVERED_CABLE.item(AEColor.TRANSPARENT)))
        ...
        ShapedRecipeBuilder.shaped(AEParts.COVERED_CABLE.item(AEColor.ORANGE), 8)
                ...
                .pattern("aaa")
                .define('a', AEParts.COVERED_CABLE.item(AEColor.TRANSPARENT))
                .define('b', ConventionTags.dye(DyeColor.ORANGE))
                .unlockedBy("has_dyes/orange", has(ConventionTags.dye(DyeColor.ORANGE)))
                .unlockedBy("has_fluix_covered_cable", has(AEParts.COVERED_CABLE.item(AEColor.TRANSPARENT)))
        ...
        ShapedRecipeBuilder.shaped(AEParts.COVERED_CABLE.item(AEColor.PINK), 8)
                ...
                .pattern("aaa")
                .define('a', AEParts.COVERED_CABLE.item(AEColor.TRANSPARENT))
                .define('b', ConventionTags.dye(DyeColor.PINK))
                .unlockedBy("has_fluix_covered_cable", has(AEParts.COVERED_CABLE.item(AEColor.TRANSPARENT)))
                .unlockedBy("has_dyes/pink", has(ConventionTags.dye(DyeColor.PINK)))
        ...
        ShapedRecipeBuilder.shaped(AEParts.COVERED_CABLE.item(AEColor.PURPLE), 8)
                ...
                .pattern("aaa")
                .define('a', AEParts.COVERED_CABLE.item(AEColor.TRANSPARENT))
                .define('b', ConventionTags.dye(DyeColor.PURPLE))
                .unlockedBy("has_dyes/purple", has(ConventionTags.dye(DyeColor.PURPLE)))
                .unlockedBy("has_fluix_covered_cable", has(AEParts.COVERED_CABLE.item(AEColor.TRANSPARENT)))
        ...
        ShapedRecipeBuilder.shaped(AEParts.COVERED_CABLE.item(AEColor.RED), 8)
                ...
                .pattern("aaa")
                .define('a', AEParts.COVERED_CABLE.item(AEColor.TRANSPARENT))
                .define('b', ConventionTags.dye(DyeColor.RED))
                .unlockedBy("has_fluix_covered_cable", has(AEParts.COVERED_CABLE.item(AEColor.TRANSPARENT)))
                .unlockedBy("has_dyes/red", has(ConventionTags.dye(DyeColor.RED)))
        ...
        ShapedRecipeBuilder.shaped(AEParts.COVERED_CABLE.item(AEColor.WHITE), 8)
                ...
                .pattern("aaa")
                .define('a', AEParts.COVERED_CABLE.item(AEColor.TRANSPARENT))
                .define('b', ConventionTags.dye(DyeColor.WHITE))
                .unlockedBy("has_dyes/white", has(ConventionTags.dye(DyeColor.WHITE)))
                .unlockedBy("has_fluix_covered_cable", has(AEParts.COVERED_CABLE.item(AEColor.TRANSPARENT)))
        ...
        ShapedRecipeBuilder.shaped(AEParts.COVERED_CABLE.item(AEColor.YELLOW), 8)
                ...
                .pattern("aaa")
                .define('a', AEParts.COVERED_CABLE.item(AEColor.TRANSPARENT))
                .define('b', ConventionTags.dye(DyeColor.YELLOW))
                .unlockedBy("has_dyes/yellow", has(ConventionTags.dye(DyeColor.YELLOW)))
                .unlockedBy("has_fluix_covered_cable", has(AEParts.COVERED_CABLE.item(AEColor.TRANSPARENT)))
        ...
        ShapedRecipeBuilder.shaped(AEItems.CERTUS_QUARTZ_AXE)
                ...
                .unlockedBy("has_crystals/certus_quartz", has(ConventionTags.CERTUS_QUARTZ))
                .unlockedBy("has_rods/wooden", has(ConventionTags.WOOD_STICK))
        ...
        ShapedRecipeBuilder.shaped(AEItems.NETHER_QUARTZ_AXE)
                ...
                .define('b', ConventionTags.WOOD_STICK)
                .unlockedBy("has_gems/quartz", has(ConventionTags.NETHER_QUARTZ))
                .unlockedBy("has_rods/wooden", has(ConventionTags.WOOD_STICK))
        ...
        ShapedRecipeBuilder.shaped(AEItems.BIOMETRIC_CARD)
                ...
                .define('d', ConventionTags.REDSTONE)
                .unlockedBy("has_ingots/iron", has(ConventionTags.IRON_INGOT))
                .unlockedBy("has_ingots/gold", has(ConventionTags.GOLD_INGOT))
                .unlockedBy("has_dusts/redstone", has(ConventionTags.REDSTONE))
                .unlockedBy("has_engineering_processor", has(AEItems.ENGINEERING_PROCESSOR))
