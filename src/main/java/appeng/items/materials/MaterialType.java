...
public enum MaterialType
{
	...
	MaterialType( String resourcePath )
	{
		this( resourcePath, EnumSet.of( AEFeature.CORE ) );
	}

	MaterialType( String resourcePath, final Set<AEFeature> features )
	{
		this.features = features;
		this.id = resourcePath;
	}

	MaterialType( String resourcePath, final Set<AEFeature> features, final Class<? extends Entity> c )
	{
		this( resourcePath, features );
		this.droppedEntity = c;
	}

	MaterialType( String resourcePath, final Set<AEFeature> features, final String oreDictionary, final Class<? extends Entity> c )
	{
		this( resourcePath, features );
	...
	MaterialType( String resourcePath, final Set<AEFeature> features, final String oreDictionary )
	{
		this( resourcePath, features );
		this.oreName = oreDictionary;
	}
	...
	void setItem( final Item itemInstance )
	{
