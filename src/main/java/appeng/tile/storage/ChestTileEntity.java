...
public class ChestTileEntity extends AENetworkPowerTileEntity
    ...
    public ChestTileEntity(TileEntityType<?> tileEntityTypeIn) {
        ...
        this.externalCellInventory.getAllRule().filterInserts(ChestTileEntity::canInsertCell);
    }
    ...
    private class FluidHandler implements FluidInsertable {
        ...
        public FluidVolume attemptInsertion(FluidVolume fluidVolume, Simulation simulation) {
            ...
            IAEFluidStack remaining = Platform.poweredInsert(ChestTileEntity.this, ChestTileEntity.this.cellHandler,
                    toInsert, ChestTileEntity.this.mySrc,
