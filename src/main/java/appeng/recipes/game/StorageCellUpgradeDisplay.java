...
public record StorageCellUpgradeDisplay(
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, StorageCellUpgradeDisplay> STREAM_CODEC = StreamCodec.composite(
    ...
    public static final RecipeDisplay.Type<StorageCellUpgradeDisplay> TYPE = new RecipeDisplay.Type<>(MAP_CODEC, STREAM_CODEC);
