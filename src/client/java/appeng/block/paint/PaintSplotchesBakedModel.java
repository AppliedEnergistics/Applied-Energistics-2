 ...
 */
class PaintSplotchesBakedModel implements DynamicBlockStateModel {
    ...
    PaintSplotchesBakedModel(SpriteGetter spriteGetter) {
        ModelDebugName debugName = null; // TODO
        this.textures = new TextureAtlasSprite[]{spriteGetter.get(TEXTURE_PAINT1, debugName),
                spriteGetter.get(TEXTURE_PAINT2, debugName), spriteGetter.get(TEXTURE_PAINT3, debugName)};
    }
    ...
    public void getQuads(QuadCollection.Builder quadListBuilder, ModelData extraData) {
    ...
    public record Unbaked() implements CustomUnbakedBlockStateModel {
        public static final MapCodec<PaintSplotchesBakedModel.Unbaked> MAP_CODEC = MapCodec.unit(PaintSplotchesBakedModel.Unbaked::new);
