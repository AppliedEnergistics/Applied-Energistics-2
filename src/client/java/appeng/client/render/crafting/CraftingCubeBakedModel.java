...
import appeng.block.paint.CraftingCubeBakedModel;
 ...
 */
abstract class CraftingCubeBakedModel implements DynamicBlockStateModel {
    ...
    public record Unbaked() implements CustomUnbakedBlockStateModel {
        public static final MapCodec<CraftingCubeBakedModel.Unbaked> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group()
                .apply(instance, CraftingCubeBakedModel.Unbaked::new));

        @Override
        public BlockStateModel bake(ModelBaker baker) {
            return new CraftingCubeBakedModel();
        }
        ...
        @Override
        public MapCodec<CraftingCubeBakedModel.Unbaked> codec() {
            return MAP_CODEC;
        }
    }    
}
