...
import appeng.block.paint.CableBusBakedModel;
...
public class CableBusBakedModel implements DynamicBlockStateModel {
    ...
    public record Unbaked() implements CustomUnbakedBlockStateModel {
        public static final MapCodec<CableBusBakedModel.Unbaked> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group()
                .apply(instance, CableBusBakedModel.Unbaked::new));

        @Override
        public BlockStateModel bake(ModelBaker baker) {
            return new CableBusBakedModel();
        }
        ...
        @Override
        public MapCodec<CableBusBakedModel.Unbaked> codec() {
            return MAP_CODEC;
        }
    }    
}
