...
import appeng.block.paint.P2PTunnelFrequencyBakedModel;
...
public class P2PTunnelFrequencyBakedModel implements DynamicBlockStateModel {
    ...
    public record Unbaked() implements CustomUnbakedBlockStateModel {
        public static final MapCodec<P2PTunnelFrequencyBakedModel.Unbaked> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group()
                .apply(instance, P2PTunnelFrequencyBakedModel.Unbaked::new));

        @Override
        public BlockStateModel bake(ModelBaker baker) {
            return new P2PTunnelFrequencyBakedModel();
        }
        ...
        @Override
        public MapCodec<P2PTunnelFrequencyBakedModel.Unbaked> codec() {
            return MAP_CODEC;
        }
    }    
}
