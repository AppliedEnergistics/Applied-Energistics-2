...
import appeng.block.paint.MeteoriteCompassBakedModel;
 ...
 */
public class MeteoriteCompassBakedModel implements DynamicBlockStateModel {
...
// TODO 1.21.4    }
    ...
    public record Unbaked() implements CustomUnbakedBlockStateModel {
        public static final MapCodec<MeteoriteCompassBakedModel.Unbaked> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group()
                .apply(instance, MeteoriteCompassBakedModel.Unbaked::new));

        @Override
        public BlockStateModel bake(ModelBaker baker) {
            return new MeteoriteCompassBakedModel();
        }
        ...
        @Override
        public MapCodec<MeteoriteCompassBakedModel.Unbaked> codec() {
            return MAP_CODEC;
        }
    }    
}
