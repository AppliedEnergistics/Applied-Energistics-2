...
import appeng.block.paint.GlassBakedModel;
...
public class GlassBakedModel implements DynamicBlockStateModel {
    ...
    public record Unbaked() implements CustomUnbakedBlockStateModel {
        public static final MapCodec<GlassBakedModel.Unbaked> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group()
                .apply(instance, GlassBakedModel.Unbaked::new));

        @Override
        public BlockStateModel bake(ModelBaker baker) {
            return new GlassBakedModel();
        }
        ...
        @Override
        public MapCodec<GlassBakedModel.Unbaked> codec() {
            return MAP_CODEC;
        }
    }    
}
