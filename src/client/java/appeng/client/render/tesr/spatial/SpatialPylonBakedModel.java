...
import appeng.block.paint.SpatialPylonBakedModel;
 ...
 */
class SpatialPylonBakedModel implements DynamicBlockStateModel {
    ...
    public record Unbaked() implements CustomUnbakedBlockStateModel {
        public static final MapCodec<SpatialPylonBakedModel.Unbaked> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group()
                .apply(instance, SpatialPylonBakedModel.Unbaked::new));

        @Override
        public BlockStateModel bake(ModelBaker baker) {
            return new SpatialPylonBakedModel();
        }
        ...
        @Override
        public MapCodec<SpatialPylonBakedModel.Unbaked> codec() {
            return MAP_CODEC;
        }
    }    
}
