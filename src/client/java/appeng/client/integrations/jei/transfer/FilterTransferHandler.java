...
import appeng.integration.modules.itemlists.FilterTransferHelper;
...
public class FilterTransferHandler<T extends UpgradeableMenu<? extends IUpgradeableObject>>
    ...
    public FilterTransferHandler(
            MenuType<T> menuType, Class<T> menuClass, IRecipeTransferHandlerHelper helper) {
    ...
    // Returning empty means the handler will not lock itself to a single MenuType from any given
    // container class.
    @Override
