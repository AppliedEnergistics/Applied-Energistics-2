...
public class CompositeBlockEntityRenderer<T extends AEBaseBlockEntity> implements BlockEntityRenderer<T> {

    private final List<Renderable<? super T>> renderables;

    @SafeVarargs
    public CompositeBlockEntityRenderer(Renderable<? super T>... renderables) {
    ...
    public void render(T blockEntity, float partialTicks, PoseStack ms, MultiBufferSource buffers, int combinedLight,
            int combinedOverlay, Vec3 cameraPosition) {
        ms.pushPose();
