...
public interface IPatternDetailsHelper {
     ...
     */
    ItemStack encodeAE2ProcessingPattern(@Nullable ItemStack stack, IAEStack[] in, IAEStack[] out);
     ...
     * @throws IllegalArgumentException If either in or out contain only empty ItemStacks.
     */
    ItemStack encodeAE2CraftingPattern(@Nullable ItemStack stack, CraftingRecipe recipe, ItemStack[] in, ItemStack out,
