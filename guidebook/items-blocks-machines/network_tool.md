...
Right-clicking any part of a network will show a diagnostic info window, similar to right-clicking an <ItemLink id="controller" />.
This window shows:

*   The number of channels in-use on the network
...
This window is also helpful for figuring out whether two different cables or devices are part of the same network when messing around with
